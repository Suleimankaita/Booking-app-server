...
// const resend = new Resend("re_g3G4yt9e_M1dDpXxBxwmwi92K9PM1HWHX");
...
//     // Note: You had a hardcoded email here in your snippet, kept it as requested
//     const user = await User.findOne({ email }).collation({ strength: 2, locale: 'en' }).exec();
//     console.log(user)
...
//     // SENDING VIA API (Bypasses Render's SMTP block)
